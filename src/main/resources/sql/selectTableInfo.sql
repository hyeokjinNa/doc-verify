SELECT 
	...
	, CASE WHEN COL.NULLABLE = 'N' THEN 'Y' END AS NOT_NULL
	, CASE WHEN CONS.CON_TYPE = 'PRIMARY KEY' THEN 'Y' END AS PK
...
LEFT OUTER JOIN ALL_COL_COMMENTS AS CMT_C ON COL.OWNER = CMT_T.OWNER AND COL.TABLE_NAME = CMT_C.TABLE_NAME AND COL.COLUMN_NAME = CMT_C.COLUMN_NAME
LEFT OUTER JOIN (
