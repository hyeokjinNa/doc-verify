SELECT 
	...
	, CASE WHEN COL.NULLABLE = 'N' THEN 'Y' ELSE 'N' END AS NOT_NULL
	, CASE WHEN CONS.CON_TYPE = 'PRIMARY KEY' THEN 'Y' ELSE 'N' END AS PK
...
WHERE COL.OWNER = ? AND COL.TABLE_NAME = ? AND COL.COLUMN_NAME = ?
